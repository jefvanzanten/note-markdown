import type { SaveResultDto, TabDto } from "@note/shared-types";
...
const STORAGE_KEY = "note-markdown-sticky-mock-session-v1";
...
const titleFromPath = (path: string) => path.split(/[\\/]/).pop() || "sticky.md";
